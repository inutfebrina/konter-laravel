...
<div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select onchange="getdata()" name="id_barang" id="id_barang" value="" class="select2 form-control">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input readonly  type="text" name="kategori" id="kategori" class="form-control">
                            </div>
</div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for=""> Sub Kategori</label>
                                <input readonly type="text" name="subkategori" id="subkategori" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
    ...
    <div class="col-md-12">
        ...
        <script>
            ...
            function getdata() {
                var id_barang = $('#id_barang option:selected').val();
                // alert(id_barang)
                $.ajax({
...
<?php echo $__env->make('template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\mediatama\konter\resources\views/page/inputtrans.blade.php ENDPATH**/ ?>