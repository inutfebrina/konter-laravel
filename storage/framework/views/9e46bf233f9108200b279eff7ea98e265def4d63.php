            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user" method="post" action="<?php echo e(route('aksi-login')); ?>">
                      <?php echo csrf_field(); ?>
...
<?php /**PATH D:\mediatama\konter\resources\views/page/login.blade.php ENDPATH**/ ?>